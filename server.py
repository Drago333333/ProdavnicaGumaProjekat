...
# RUTA KOJA OBRAĐUJE KUPOVINU I PRAZNI KORPU
...
def kupi():
    ...
    sql = "INSERT INTO porudzbine (ime_prezime, adresa, telefon, ukupna_cena) VALUES (%s, %s, %s, %s)"
    kursor.execute(sql, (ime_prezime, adresa, telefon, ukupna_cena))
    konekcija.commit()
    ...
    return "<h1 style='text-align:center; margin-top:50px; color:green;'>Hvala na kupovini! Vaša narudžbina je uspešno zabeležena." \
    "</h1><div style='text-align:center;'><a href='/'>Vrati se na početnu</a></div>"
