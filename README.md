...
3. Instalirajte potrebne dodatke tako sto cete napisati sledece u terminalu: pip install -r requirements.txt
...
-Kada vlasnik/admin zeli da promeni status nekog zakazanog servisa, to moze da uradi na sledeci nacin, on mora biti admin:

-Podaci za admin nalog su e-mail: admin@gmail.com  sifra: admin000 

-Kada se ulogujete, pored Ulogujte se / Odjavite se stajace vam ADMIN PANEL kada kliknete na njega odvesce vas na stranicu:
 http://127.0.0.1:5000/admin/servisi  na ovoj stranici mozete da azurirate trenutni status servisa nekog vozila.

 -U gornjem desnom uglu ako kliknete na Upravljaj korisnicima, odvesce vas na stranicu http://127.0.0.1:5000/admin/korisnici

 -Na ovoj stranici vi kao admin mozete da dodelite ili uklonite admin prava bilo kojem korisniku (osim sebi).
